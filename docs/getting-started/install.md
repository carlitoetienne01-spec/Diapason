...
|---|---|---|
| **macOS** | `curl -fsSL https://open-diapason.github.io/Diapason/install.sh \| bash` | [macOS install](macos.md) |
| **Linux** | `curl -fsSL https://open-diapason.github.io/Diapason/install.sh \| bash` | [Linux install](linux.md) |
| **WSL2 on Windows** | `curl -fsSL https://open-diapason.github.io/Diapason/install.sh \| bash` (run inside Ubuntu) | [WSL2 install](wsl2.md) |
| **Native Windows** | `irm https://open-diapason.github.io/Diapason/install.ps1 \| iex` | [Native Windows install](windows-native.md) |
| **Desktop GUI** | Download from the [latest release](https://github.com/open-diapason/Diapason/releases) | — |
...
!!! info "Install URL"
    ...
    intermittent TLS issues ([#337](https://github.com/open-diapason/Diapason/issues/337)).
    The `open-diapason.github.io` URL above is the canonical one.
