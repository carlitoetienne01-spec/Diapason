...
| **Curseur / clic / double-clic / défilement** | ⚠️ | ❌ | ❌ | ❌ | ❌ | Livré dans un mode `POINTER` distinct : acquisition sur 3 images, perte brève tolérée 280 ms sans autoriser de clic, filtre adaptatif, pincement confirmé avec 140 ms de tolérance au pouce masqué et jauge de proximité. L'injection Core Graphics et le refus sans Accessibilité sont confirmés physiquement ; la fluidité corrigée attend son essai. Écran principal seulement. Windows n'a pas encore de suivi de main. |
