...
| **Curseur / clic / double-clic / défilement** | ⚠️ | ❌ | ❌ | ❌ | ❌ | Livré dans un mode `POINTER` distinct : acquisition sur 3 images, perte brève tolérée 280 ms sans autoriser de clic, pincement confirmé et maintien pour défiler. L'injection Core Graphics et le refus sans Accessibilité sont confirmés physiquement ; la continuité corrigée attend son second essai. Écran principal seulement. Windows n'a pas encore de suivi de main. |
