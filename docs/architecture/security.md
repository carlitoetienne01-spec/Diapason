...
The default path is `~/.diapason/audit.db`, configurable via `security.audit_log_path` in `config.toml`.
...
- [API Reference: Security](../api-reference/diapason/security/index.md) — complete class and function signatures
