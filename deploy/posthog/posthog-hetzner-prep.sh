...
# Diapason's self-hosted PostHog analytics backend.
#
...
#
# Usage:
#   sudo bash posthog-hetzner-prep.sh analytics.diapason.ai you@diapason.ai
#
# After it finishes:
#   1. Visit https://<DOMAIN>/ and create the admin account.
#   2. Create project "Diapason".
...
Examples:
  sudo bash posthog-hetzner-prep.sh analytics.diapason.ai team@diapason.ai
...
Next steps:
  ...
  8. Ship a release of Diapason with the new config defaults.
