...
Thank you for your interest in contributing to Diapason! This guide covers everything you need to know — from why to contribute, to how to submit your first pull request.

---

## Why Contribute?

Contributing to Diapason isn't just about code — it's about building the future of on-device AI together. Here's what you get:
...
See the [Savings Leaderboard](https://open-diapason.github.io/Diapason/leaderboard/) for details.
...
Look for issues labeled [`good-first-issue`](https://github.com/open-diapason/Diapason/labels/good-first-issue).
...
1. Browse the [Roadmap](https://open-diapason.github.io/Diapason/development/roadmap/) for an item that interests you
2. Check if a [GitHub issue](https://github.com/open-diapason/Diapason/issues) already exists for it — if not, [open one](https://github.com/open-diapason/Diapason/issues/new/choose) describing what you'd like to work on
...
Use the appropriate [issue template](https://github.com/open-diapason/Diapason/issues/new/choose):
...
Diapason is built on five composable primitives. Here's where you can contribute:
...
- Open a [Discussion](https://github.com/open-diapason/Diapason/discussions) for questions and help
- Check the [documentation](https://open-diapason.github.io/Diapason/) for guides and API reference
