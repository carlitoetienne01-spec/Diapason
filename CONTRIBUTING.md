...
Look for issues labeled [`good-first-issue`](https://github.com/carlitoetienne01-spec/Diapason/labels/good-first-issue).
...
1. Browse the [Roadmap](https://carlitoetienne01-spec.github.io/Diapason/development/roadmap/) for an item that interests you
2. Check if a [GitHub issue](https://github.com/carlitoetienne01-spec/Diapason/issues) already exists for it — if not, [open one](https://github.com/carlitoetienne01-spec/Diapason/issues/new/choose) describing what you'd like to work on
...
Use the appropriate [issue template](https://github.com/carlitoetienne01-spec/Diapason/issues/new/choose):
...
- Open a [Discussion](https://github.com/carlitoetienne01-spec/Diapason/discussions) for questions and help
- Check the [documentation](https://carlitoetienne01-spec.github.io/Diapason/) for guides and API reference
