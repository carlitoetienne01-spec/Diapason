...
class TestDetectHardware:
    ...
    @patch("diapason.core.config.shutil.which", return_value="/usr/bin/nvidia-smi")
    @patch(
        "diapason.core.config._run_cmd",
    ...
    @patch("diapason.core.config.shutil.which", return_value="/usr/bin/rocm-smi")
    @patch(
        "diapason.core.config._run_cmd",
        side_effect=[
    ...
    @patch("diapason.core.config.platform.system", return_value="Darwin")
    @patch(
        "diapason.core.config._run_cmd",
        return_value=(
            "Graphics/Displays:\n"
    ...
    @patch("diapason.core.config.shutil.which", return_value=None)
    @patch("diapason.core.config.platform.system", return_value="Linux")
