...
class TestScorerInstantiation:
    ...
    def test_swefficiency_scorer(self) -> None:
        from diapason.evals.scorers.swefficiency_structural import (
            SWEfficiencyScorer,
        )
...
class TestCLIFactories:
    ...
    def test_build_dataset(self, benchmark: str) -> None:
        from diapason.evals.cli import _build_dataset
    ...
    def test_build_scorer(self, benchmark: str) -> None:
        from diapason.evals.cli import _build_scorer
...
class TestConfigBenchmarks:
    ...
    def test_all_benchmarks_known(self) -> None:
        from diapason.evals.core.config import KNOWN_BENCHMARKS
...
class TestStructuralScorers:
    ...
    def test_swebench_empty_response(self) -> None:
        from diapason.evals.core.types import EvalRecord
        from diapason.evals.scorers.swebench_structural import SWEBenchScorer
