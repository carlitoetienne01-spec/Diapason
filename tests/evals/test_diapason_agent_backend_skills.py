"""Tests for DiapasonAgentBackend skills_enabled / overlay_dir kwargs (Plan 2B)."""
...
class TestDiapasonAgentBackendSkillsKwargs:
    ...
    def test_init_signature_accepts_kwargs_without_engine(self):
        ...
        sig = inspect.signature(DiapasonAgentBackend.__init__)
