...
PROVIDERS = [
    ("diapason.evals.datasets.pinchbench", "PinchBenchDataset"),
    ("diapason.evals.datasets.liveresearch", "LiveResearchBenchDataset"),
    ("diapason.evals.datasets.gaia", "GAIADataset"),
    ("diapason.evals.datasets.liveresearchbench", "LiveResearchBenchDataset"),
    ("diapason.evals.datasets.taubench", "TauBenchDataset"),
    ("diapason.evals.datasets.toolcall15", "ToolCall15Dataset"),
    ("diapason.evals.datasets.livecodebench", "LiveCodeBenchDataset"),
]
