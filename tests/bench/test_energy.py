...
from diapason.bench.energy import EnergyBenchmark
from diapason.core.registry import BenchmarkRegistry
from diapason.telemetry.energy_monitor import EnergySample


@pytest.fixture(autouse=True)
def _register_energy():
    """Re-register energy benchmark after registry clear."""
    from diapason.bench.energy import ensure_registered
