...
def connector(tmp_path: Path):
    ...
    from diapason.connectors.notion import NotionConnector  # noqa: PLC0415
...
@patch("diapason.connectors.notion._notion_api_search")
@patch("diapason.connectors.notion._notion_api_get_blocks")
...
def test_render_blocks_to_markdown() -> None:
    ...
    from diapason.connectors.notion import _render_blocks_to_markdown  # noqa: PLC0415
