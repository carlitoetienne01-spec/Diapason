...
def connector(tmp_path: Path):
    ...
    from diapason.connectors.gdrive import GDriveConnector  # noqa: PLC0415
...
@patch("diapason.connectors.gdrive._gdrive_api_list_files")
@patch("diapason.connectors.gdrive._gdrive_api_export")
