...
def connector(tmp_path: Path):
    ...
    from diapason.connectors.granola import GranolaConnector  # noqa: PLC0415
...
@patch("diapason.connectors.granola._granola_api_list_notes")
@patch("diapason.connectors.granola._granola_api_get_note")
...
def test_format_note_content() -> None:
    ...
    from diapason.connectors.granola import _format_note_content  # noqa: PLC0415
...
def test_sync_logs_note_count(
    ...
    with caplog.at_level(logging.INFO, logger="diapason.connectors.granola"):
        list(connector.sync())
...
def test_end_to_end_ingest_and_search(
    ...
    from diapason.agents.research_loop import (  # noqa: PLC0415
        _hit_url,
...
def test_validate_key_empty_raises() -> None:
    ...
    from diapason.connectors.granola import (  # noqa: PLC0415
        GranolaKeyError,
...
def test_validate_key_rejects_unauthorized(status: int) -> None:
    ...
    with patch(
        "diapason.connectors.granola.httpx.get",
...
@patch("diapason.connectors.granola._granola_api_validate_key")
...
def test_handle_callback_invalid_key_does_not_overwrite_existing(connector) -> None:
    ...
    from diapason.connectors.granola import GranolaKeyError  # noqa: PLC0415
