...
class TestOuraLive:
    def test_sync_returns_documents(self):
        from diapason.connectors.oura import OuraConnector
...
class TestStravaLive:
    def test_sync_returns_documents(self):
        from diapason.connectors.strava import StravaConnector
...
class TestSpotifyLive:
    def test_sync_returns_documents(self):
        from diapason.connectors.spotify import SpotifyConnector
...
class TestGoogleTasksLive:
    def test_sync_returns_documents(self):
        from diapason.connectors.google_tasks import GoogleTasksConnector
