...
def connector(tmp_path: Path):
    ...
    from diapason.connectors.gmail import GmailConnector  # noqa: PLC0415
...
@patch("diapason.connectors.gmail._gmail_api_list_messages")
@patch("diapason.connectors.gmail._gmail_api_get_message")
...
def test_html_to_text_strips_basic_tags() -> None:
    ...
    from diapason.connectors.gmail import _html_to_text  # noqa: PLC0415
...
def test_401_triggers_refresh_and_retries_with_new_token(tmp_path: Path) -> None:
    ...
    from diapason.connectors import gmail as gmail_mod
