...
from diapason.agents._stubs import AgentResult, BaseAgent, ToolUsingAgent
...
class TestBaseAgentConfigResolution:
    ...
    def test_none_temperature_reads_config(self):
        ...
        engine = MagicMock()
        with patch("diapason.agents._stubs.load_config") as mock_cfg:
    ...
    def test_config_load_failure_uses_hardcoded_fallback(self):
        ...
        engine = MagicMock()
        with patch(
            "diapason.agents._stubs.load_config",
