...
from diapason.server.webhook_routes import create_webhook_router
...
class TestTwilioWebhook:
    ...
    def test_valid_twilio_webhook(self, twilio_client, mock_bridge):
        with patch(
            "diapason.server.webhook_routes._validate_twilio_signature",
            return_value=True,
        ):
...
class TestWhatsAppWebhook:
    ...
    def wa_app(self, mock_bridge):
        ...
        router = create_webhook_router(
            bridge=mock_bridge,
            whatsapp_verify_token="wa_verify_123",  # gitleaks:allow
    ...
    def test_verification_challenge(self, wa_client):
        resp = wa_client.get(
            ...
            params={
                "hub.mode": "subscribe",
                "hub.verify_token": "wa_verify_123",  # gitleaks:allow
