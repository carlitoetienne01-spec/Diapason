...
from diapason.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_transcribe():
    ...
    with patch("diapason.speech.deepgram.DeepgramClient", return_value=mock_client):
        from diapason.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_health():
    with patch("diapason.speech.deepgram.DeepgramClient"):
        from diapason.speech.deepgram import DeepgramSpeechBackend
