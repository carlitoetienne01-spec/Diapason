...
from diapason.speech.openai_whisper import OpenAIWhisperBackend
...
def test_openai_whisper_transcribe():
    ...
    with patch("diapason.speech.openai_whisper.OpenAI", return_value=mock_client):
        from diapason.speech.openai_whisper import OpenAIWhisperBackend
...
def test_openai_whisper_health():
    with patch("diapason.speech.openai_whisper.OpenAI"):
        from diapason.speech.openai_whisper import OpenAIWhisperBackend
