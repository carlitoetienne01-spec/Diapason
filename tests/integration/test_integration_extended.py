...
class TestOpenHandsPipeline:
    ...
    def test_openhands_code_execution_e2e(self):
        _register_all()
        from diapason.agents.native_openhands import NativeOpenHandsAgent
        from diapason.tools.code_interpreter import (
            CodeInterpreterTool,
        )
...
class TestMCPIntegration:
    ...
    def test_mcp_server_with_all_tools(self):
        ...
        from diapason.mcp.transport import InProcessTransport
        from diapason.tools.calculator import CalculatorTool
        from diapason.tools.think import ThinkTool
    ...
    def test_mcp_unknown_tool_error(self):
        from diapason.mcp.client import MCPClient
        from diapason.mcp.protocol import MCPError
        from diapason.mcp.server import MCPServer
        from diapason.mcp.transport import InProcessTransport
        from diapason.tools.calculator import CalculatorTool
...
class TestModelCatalogIntegration:
    ...
    def test_all_models_routable(self):
        ...
        from diapason.intelligence.model_catalog import (
            BUILTIN_MODELS,
        )
