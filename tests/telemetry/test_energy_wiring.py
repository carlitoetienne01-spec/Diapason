...
_bench_mod = importlib.import_module("diapason.cli.bench_cmd")
...
class TestCliAskWiring:
    ...
    def test_energy_monitor_created_when_gpu_metrics_on(
        ...
        with patch(
            "diapason.telemetry.energy_monitor.create_energy_monitor",
...
class TestBenchWiring:
    ...
    def test_energy_monitor_passed_to_benchmarks(self):
        ...
        with (
            patch(
                "diapason.cli.bench_cmd.get_engine",
                return_value=("mock", engine),
            ),
            patch(
                "diapason.cli.bench_cmd.load_config",
                return_value=cfg,
            ),
            patch(
                "diapason.telemetry.energy_monitor.create_energy_monitor",
