...
from diapason.tools.git_tool import (
    GitCommitTool,
    GitDiffTool,
    GitLogTool,
    GitStatusTool,
...
class TestGitStatusTool:
    ...
    def test_clean_repo(self, tmp_path):
        ...
        with patch("diapason.tools.git_tool.get_rust_module", return_value=mock_mod):
...
class TestGitCommitTool:
    ...
    def test_git_not_found(self):
        tool = GitCommitTool()
        with patch("diapason.tools.git_tool.shutil.which", return_value=None):
