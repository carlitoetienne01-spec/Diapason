...
_PATCH_HTTP = "diapason.mcp.transport.StreamableHTTPTransport"
_PATCH_STDIO = "diapason.mcp.transport.StdioTransport"
_PATCH_CLIENT = "diapason.mcp.client.MCPClient"
_PATCH_PROVIDER = "diapason.tools.mcp_adapter.MCPToolProvider"
_PATCH_LOGGER = "diapason.system.builder.logger"
