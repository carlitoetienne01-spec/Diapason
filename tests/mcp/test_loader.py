...
def _mock_mcp_stack():
    ...
    with (
        patch("diapason.mcp.client.MCPClient") as MockClient,
        patch("diapason.mcp.transport.StreamableHTTPTransport") as MockHttp,
        patch("diapason.mcp.transport.StdioTransport") as MockStdio,
