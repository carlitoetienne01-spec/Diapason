"""Tests for diapason.learning.spec_search.execute.base module."""
...
class TestValidationResult:
    ...
    def test_ok_result(self) -> None:
        from diapason.learning.spec_search.execute.base import ValidationResult
...
class TestEditApplierRegistry:
    ...
    def test_register_and_get(self) -> None:
        from diapason.learning.spec_search.execute.base import (
            ApplyContext,
            ApplyResult,
            EditApplier,
            EditApplierRegistry,
        ...
        from diapason.learning.spec_search.models import Edit, EditOp
