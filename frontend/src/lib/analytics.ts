...
/**
 * Mirror of the Python event catalog (src/diapason/analytics/events.py
    ...
    if (import.meta.env.DEV) {
      console.warn(
        `[analytics] Unknown event "${event}" dropped. ` +
          ...
          `REGISTRY in src/diapason/analytics/events.py.`,
      );
    }
    return;
  }
 ...
 * :func:`diapason.analytics.redaction.hash_id`.
 */
