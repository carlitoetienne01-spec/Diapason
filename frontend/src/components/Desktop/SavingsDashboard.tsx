...
const OPTIN_KEY = 'diapason-desktop-optin';
const OPTIN_NAME_KEY = 'diapason-desktop-display-name';
const OPTIN_EMAIL_KEY = 'diapason-desktop-email';
const OPTIN_ANONID_KEY = 'diapason-desktop-anon-id';
