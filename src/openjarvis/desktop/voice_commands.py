...
def parse_voice_command(text: str) -> VoiceAction:
    ...
    try:
        from openjarvis.desktop.smart_intents import KIND_NONE, parse_smart_intent
...
def finalize_dictation(
    ...
    *,
    ...
    try:
        ...
        if email_mode is None:
            if mode in ("on", "true", "1", "yes"):
                ...
                try:
                    from openjarvis.desktop.frontmost import is_email_composer_context
    ...
    text_gate = True
    try:
        from openjarvis.core.config import load_config as _lc
