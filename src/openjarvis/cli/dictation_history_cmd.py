...
def list_entries(limit: int, full: bool) -> None:
    ...
    from openjarvis.desktop.dictation_history import load_history
...
def show_stats() -> None:
    ...
    from openjarvis.desktop.dictation_history import load_history, stats
...
def clear() -> None:
    ...
    from openjarvis.desktop.dictation_history import clear_history
