...
def heartbeat_status() -> None:
    ...
    from openjarvis.core.config import load_config
    from openjarvis.heartbeat.markdown import ensure_heartbeat_file, pending_now, read_heartbeat
...
def heartbeat_list() -> None:
    """List ## Now tasks."""
    from openjarvis.heartbeat.markdown import read_heartbeat
...
def heartbeat_add(text: str) -> None:
    ...
    from openjarvis.heartbeat.markdown import append_task
...
def heartbeat_clear_done() -> None:
    ...
    from openjarvis.heartbeat.markdown import clear_done
