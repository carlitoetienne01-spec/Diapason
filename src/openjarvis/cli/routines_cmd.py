...
def routines_list() -> None:
    ...
    from openjarvis.heartbeat.routines import load_routines, load_state
...
def routines_enable(routine_id: str) -> None:
    from openjarvis.heartbeat.routines import set_routine_enabled
...
def routines_sync() -> None:
    ...
    from openjarvis.heartbeat.sync import sync_heartbeat_and_routines
...
def routines_preview() -> None:
    ...
    from openjarvis.heartbeat.routines import load_routines
