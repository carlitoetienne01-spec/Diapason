...
def create_dictation_router() -> APIRouter:
    ...
    def polish_only(body: DictationFinalizeRequest) -> Dict[str, Any]:
        from openjarvis.speech.dictate_polish import polish_pipeline
    ...
    def get_dictionary() -> Dict[str, Any]:
        from openjarvis.speech.dictation_dictionary import dictionary_to_api

        return dictionary_to_api()

    @router.post("/dictionary")
    def put_dictionary_entry(body: DictionaryEntryIn) -> Dict[str, Any]:
        from openjarvis.speech.dictation_dictionary import DictionaryEntry, upsert_entry
    ...
    def learn_dictionary(body: DictionaryLearnRequest) -> Dict[str, Any]:
        ...
        from openjarvis.speech.dictation_dictionary import learn_from_correction
