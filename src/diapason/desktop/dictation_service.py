...
from diapason.desktop.ptt import Action, PushToTalk
...
class DictationService:
    ...
    def _finish_and_paste(self) -> Optional[str]:
        ...
        if audio is None or len(audio) == 0:
            ...
            return None
        from diapason.desktop.mic_capture import rms_level
    ...
    def start(self) -> None:
        from diapason.desktop.hotkey import HotkeyListener
