...
BUNDLE_ID = "com.diapason.dictation"
BUNDLE_NAME = "Diapason Dictation"
EXECUTABLE_NAME = "diapason-dictate"

_MIC_REASON = (
    "Diapason records audio only while you hold the dictation key, "
    "so it can turn your speech into text on this Mac."
)
_INPUT_REASON = (
    "Diapason watches for the dictation hotkey so you can start "
