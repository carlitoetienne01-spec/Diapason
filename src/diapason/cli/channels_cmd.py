...
def channels_status() -> None:
    ...
    from diapason.channels.imessage_daemon import is_running
    ...
    if background:
        ...
        proc = subprocess.Popen(
            [
                sys.executable,
                "-m",
                "diapason.channels.imessage_daemon",
                "--chat",
                chat_identifier,
            ],
        ...
        from diapason.connectors.retriever import (
            TwoStageRetriever,
        )
        from diapason.connectors.store import KnowledgeStore
        from diapason.engine.ollama import OllamaEngine
        from diapason.tools.knowledge_search import (
            KnowledgeSearchTool,
        )
        from diapason.tools.knowledge_sql import (
            KnowledgeSQLTool,
        )
...
def imessage_stop() -> None:
    ...
    from diapason.channels.imessage_daemon import stop_daemon
