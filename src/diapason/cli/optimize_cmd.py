...
def optimize_run(
    ...
    if config_path is not None:
        try:
            from diapason.learning.optimize.config import load_optimize_config
        except ImportError:
    ...
    if data is not None:
        try:
            from diapason.learning.optimize.config import load_benchmark_specs
    ...
    try:
        ...
        from diapason.learning.optimize.config import load_objectives
        ...
        from diapason.learning.optimize.search_space import (
            DEFAULT_SEARCH_SPACE,
            build_search_space,
        )
        from diapason.learning.optimize.store import OptimizationStore
        from diapason.learning.optimize.trial_runner import (
        ...
        try:
            from diapason.evals.cli import _build_judge_backend
...
def skills(policy: str, min_traces: int, dry_run: bool) -> None:
    ...
    from diapason.learning.agents.skill_optimizer import SkillOptimizer
