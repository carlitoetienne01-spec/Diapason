...
from diapason.channels.local_trigger import LocalTriggerChannel, default_trigger_path
from diapason.desktop.welcome_runner import run_welcome_sequence
from diapason.speech.clap_listener import ClapConfig, ClapListener, choose_input_device
