...
def _instantiate_connector(connector_id: str, config: Dict[str, Any]) -> Any:
    ...
    if connector_id == "apple_notes":
        from diapason.connectors.apple_notes import AppleNotesConnector
        ...
        from diapason.connectors.gmail_imap import GmailIMAPConnector

        return GmailIMAPConnector()
    elif connector_id == "outlook":
        from diapason.connectors.outlook import OutlookConnector

        return OutlookConnector()
    elif connector_id == "slack":
        from diapason.connectors.slack_connector import SlackConnector

        return SlackConnector()
    elif connector_id == "notion":
        from diapason.connectors.notion import NotionConnector

        return NotionConnector()
    elif connector_id == "granola":
        from diapason.connectors.granola import GranolaConnector
