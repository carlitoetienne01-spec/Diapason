...
from diapason.core.config import HardwareInfo, detect_hardware, load_config
...
from diapason.mining._models import (
    get_pearl_model_spec,
    iter_pearl_model_specs,
    pearl_variant_for_base_model,
)
from diapason.mining._stubs import Sidecar
from diapason.mining.vllm_pearl import ensure_registered as ensure_vllm_registered
...
def _ensure_providers_registered() -> None:
    ...
    from diapason.mining.cpu_pearl import ensure_registered as ensure_cpu_registered

    ensure_cpu_registered()
    try:
        from diapason.mining.apple_mps_pearl import (
...
def logs(tail_n: int, follow: bool) -> None:
    ...
    try:
        launcher._container = client.containers.get("diapason-pearl-miner")
    except Exception as exc:  # noqa: BLE001
