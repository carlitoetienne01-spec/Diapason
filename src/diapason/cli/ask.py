...
from diapason.cli._tool_names import resolve_tool_names
from diapason.cli.hints import hint_no_engine
...
def _run_research(
    *,
    ...
    from diapason.agents.research_loop import DEFAULT_PLANNER_MODEL, ResearchAgent
...
@click.option(
    ...
    default=None,
    help=(
        "Named persona dir under ~/.diapason/personas/<name>/ "
...
def ask(
    ...
    if capture_screen:
        try:
            from diapason.cli._screen import capture_screen_to_temp
