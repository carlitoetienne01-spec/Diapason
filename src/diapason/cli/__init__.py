...
import diapason
from diapason.cli._bootstrap import bootstrap_cmd
from diapason.cli.add_cmd import add
from diapason.cli.agent_cmd import agent
from diapason.cli.ask import ask
from diapason.cli.bench_cmd import bench
from diapason.cli.channel_cmd import channel
...
from diapason.cli.optimize_cmd import optimize_group
...
@click.group(
    help="Diapason — modular AI assistant backend",
    invoke_without_command=True,
)
@click.version_option(version=diapason.__version__, prog_name="diapason")
...
def cli(ctx: click.Context, verbose: bool, quiet: bool) -> None:
    ...
    if not quiet and ctx.invoked_subcommand and not research_mode_active:
        ...
        from diapason.cli._version_check import check_for_updates
...
cli.add_command(serve_service, "serve-service")
...
try:
    from diapason.cli.auth_cmd import auth
...
try:
    from diapason.cli.tunnel_cmd import tunnel
