...
from diapason.core.registry import ToolRegistry, TTSRegistry
...
class TextToSpeechTool(BaseTool):
            ...
            parameters={
                ...
                "properties": {
                    ...
                    "backend": {
                        "type": "string",
                        "description": (
                            "TTS backend (cartesia, kokoro, openai_tts, elevenlabs)."
                        ),
                    },
                    "output_dir": {
                        "type": "string",
    ...
    def execute(self, **params: Any) -> ToolResult:
        ...
        import diapason.speech  # noqa: F401

        text = params.get("text", "")
        voice_id = params.get("voice_id", "")
        backend_key = params.get("backend", "cartesia")
        _ALIASES = {"openai": "openai_tts", "eleven": "elevenlabs"}
        ...
        if output_dir:
            ...
            out_dir = Path(tempfile.mkdtemp(prefix="diapason-tts-"))
