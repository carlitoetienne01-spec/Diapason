...
def create_energy_monitor(
    ...
    try:
        from diapason.telemetry.energy_nvidia import NvidiaEnergyMonitor
    ...
    try:
        from diapason.telemetry.energy_amd import AmdEnergyMonitor
    ...
    try:
        from diapason.telemetry.energy_apple import AppleEnergyMonitor
    ...
    try:
        from diapason.telemetry.energy_rapl import RaplEnergyMonitor
