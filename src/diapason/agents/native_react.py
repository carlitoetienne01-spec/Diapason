...
from diapason.agents.prompt_loader import (
...
from diapason.core.types import Message, Role, ToolCall, ToolResult, _message_to_dict
from diapason.engine._stubs import InferenceEngine
from diapason.tools._stubs import BaseTool, build_tool_descriptions
