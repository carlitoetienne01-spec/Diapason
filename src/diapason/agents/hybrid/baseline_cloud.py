...
matrix (see ``.diapason/experiments/hybrid/docs/results-table.md``).
...
from diapason.agents.hybrid._prices import cost as estimate_cost
from diapason.agents.hybrid._prices import default_max_output_tokens
