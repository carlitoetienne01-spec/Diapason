...
# src/diapason/agents/hybrid/registry/<method>.toml
...
#
# Then run:
#   python -m diapason.agents.hybrid.runner --cell <printed name>
...
echo "Run with: python -m diapason.agents.hybrid.runner --cell ${name}"
