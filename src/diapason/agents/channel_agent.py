...
Routes incoming :class:`~diapason.channels._stubs.ChannelMessage` objects
...
from diapason.channels._stubs import BaseChannel, ChannelMessage
...
_ESCALATION_TEMPLATE = "{preview}...\n\n---\nFull report ready — open in Diapason:\ndiapason://research/{session_id}"
...
class ChannelAgent:
    ...
    agent:
        ...
        method (typically a :class:`~diapason.agents._stubs.BaseAgent`
        subclass).
    max_workers:
