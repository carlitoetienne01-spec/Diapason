...
called from your app startup:
    ...
    from diapason.agents.proactive_agent import register_cron
...
from diapason.agents._stubs import AgentContext, AgentResult, ToolUsingAgent
...
from diapason.tools.proactive_tools import get_store
...
class ProactiveAgent(ToolUsingAgent):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        from diapason.tools.channel_tools import ChannelSendTool
        from diapason.tools.digest_collect import DigestCollectTool
        from diapason.tools.proactive_tools import (
            CheckPermissionTool,
