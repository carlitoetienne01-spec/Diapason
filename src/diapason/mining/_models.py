...
from diapason.mining._constants import DEFAULT_PEARL_MODEL
...
class PearlModelSpec:
    """Diapason support metadata for a Pearl-compatible model."""
...
PEARL_MODEL_SPECS: tuple[PearlModelSpec, ...] = (
    ...
    PearlModelSpec(
        ...
        notes=(
            ...
            "Diapason before mining is enabled by default."
        ),
    ),
    PearlModelSpec(
