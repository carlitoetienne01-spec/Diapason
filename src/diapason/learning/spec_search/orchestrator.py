...
from diapason.learning.spec_search.diagnose.runner import DiagnosisRunner
from diapason.learning.spec_search.execute.base import ApplyContext
from diapason.learning.spec_search.execute.loop import _build_registry
from diapason.learning.spec_search.gate.benchmark_gate import BenchmarkGate
from diapason.learning.spec_search.gate.cold_start import check_readiness
...
from diapason.learning.spec_search.pending_queue import PendingQueue
from diapason.learning.spec_search.plan.planner import LearningPlanner
...
class SpecSearchOrchestrator:
    ...
    def from_config(
        ...
        *,
        ...
        See ``configs/diapason/examples/spec-search-quickstart.toml`` for
        the TOML schema and ``examples/diapason/spec_search_quickstart.py``
