...
from diapason.core.types import Trace, TraceStep
from diapason.skills.manager import SkillManager
from diapason.skills.overlay import SkillOverlay, write_overlay
...
class SkillOptimizer:
    ...
    def _run_dspy(
        ...
        """
        from diapason.core.config import DSPyOptimizerConfig
        from diapason.learning.agents.dspy_optimizer import DSPyAgentOptimizer
    ...
    def _run_gepa(
        ...
        from diapason.learning.agents.gepa_optimizer import GEPAAgentOptimizer
