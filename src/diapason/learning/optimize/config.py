...
from diapason.learning.optimize.types import ObjectiveSpec
...
def load_objectives(data: Dict[str, Any]) -> List[ObjectiveSpec]:
    ...
    """
    from diapason.learning.optimize.types import DEFAULT_OBJECTIVES
...
def load_benchmark_specs(data: Dict[str, Any]) -> List[Any]:
    ...
    """
    from diapason.learning.optimize.trial_runner import BenchmarkSpec
