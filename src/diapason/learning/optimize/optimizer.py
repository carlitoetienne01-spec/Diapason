...
from diapason.learning.optimize.types import (
    ObjectiveSpec,
    OptimizationRun,
    SearchSpace,
    TrialResult,
...
class OptimizationEngine:
    ...
    def run(
        ...
        from diapason.learning.optimize.trial_runner import MultiBenchTrialRunner
        ...
        for trial_num in range(1, self.max_trials + 1):
            ...
            if result.summary is not None:
                ...
                from diapason.evals.core.types import RunSummary as _RS
