...
Uses a cloud LLM to propose optimal Diapason configs, inspired by DSPy's
...
class LLMOptimizer:
    ...
    def _build_initial_prompt(self) -> str:
        ...
        lines: List[str] = []
        lines.append("You are optimizing an Diapason AI system configuration.")
        lines.append("")
    ...
    def _build_analyze_prompt(
        ...
        lines: List[str] = []
        lines.append("Analyze this Diapason evaluation result.")
        lines.append("")
