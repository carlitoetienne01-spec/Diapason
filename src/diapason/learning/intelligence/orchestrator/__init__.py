...
- **Environment**: RL environment using Diapason ToolExecutor
...
``orchestrator_grpo`` in :class:`~diapason.core.registry.LearningRegistry`.
"""
...
from diapason.learning.intelligence.orchestrator.policy_model import (
    OrchestratorPolicyModel,
)
from diapason.learning.intelligence.orchestrator.prompt_registry import (
    TOOL_DESCRIPTIONS,
    build_system_prompt,
)
from diapason.learning.intelligence.orchestrator.reward import (
...
from diapason.learning.intelligence.orchestrator.types import (
    Episode,
    EpisodeState,
    EpisodeStep,
    OrchestratorAction,
