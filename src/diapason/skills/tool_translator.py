"""ToolTranslator — translate external tool names to Diapason equivalents.

External skill libraries (Hermes Agent, OpenClaw) reference tools by Claude
Code's standard tool names (Bash, Read, Write, etc.).  Diapason uses
...
# ---------------------------------------------------------------------------
# Translation table — external name → Diapason name
# ---------------------------------------------------------------------------
