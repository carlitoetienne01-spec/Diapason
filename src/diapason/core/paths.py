...
3. ``~/.diapason`` — the historical default. With no env vars set, the
...
override. Modules that previously hardcoded ``Path.home() / ".diapason"``
...
_DEFAULT_DIR_NAME = ".diapason"
_XDG_SUBDIR_NAME = "diapason"
