...
The internal bus (:mod:`diapason.core.events`) carries dozens of
...
from diapason.analytics.redaction import hash_id
from diapason.core.events import Event, EventType
    ...
    def _on_tool_end(self, event: Event) -> None:
        try:
            ...
            if first:
                ...
                from diapason.analytics.events import KNOWN_TOOL_NAMES
