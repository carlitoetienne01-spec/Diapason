...
from diapason.evals.core.dataset import DatasetProvider
from diapason.evals.core.export import _hardware_info_dict
from diapason.evals.core.scorer import Scorer
from diapason.evals.core.tracker import ResultTracker
...
try:
    from diapason.telemetry.efficiency import compute_efficiency
except ImportError:  # pragma: no cover
    compute_efficiency = None  # type: ignore[assignment]

try:
    from diapason.telemetry.efficiency import estimate_model_flops_per_token
except ImportError:  # pragma: no cover
...
class EvalRunner:
    ...
    def run(
        ...
        from diapason.evals.core.dataset import DatasetProvider as _DP
    ...
    def _process_one(self, record: EvalRecord) -> EvalResult:
        ...
        def _backend_error_result(full: dict, message: str) -> EvalResult:
            ...
            return EvalResult(
                ...
                framework=full.get(
                    "framework",
                    getattr(self._backend, "framework_name", "diapason"),
                ),
        ...
        try:
            ...
            return EvalResult(
                ...
                framework=full.get("framework", "diapason"),
            ...
            return EvalResult(
                ...
                model_answer="",
                error=str(exc),
                framework=getattr(self._backend, "framework_name", "diapason"),
