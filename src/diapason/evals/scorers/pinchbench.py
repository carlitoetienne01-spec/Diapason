...
Provides transcript translation (Diapason events → PinchBench format),
...
from diapason.evals.core.event_recorder import EventType
from diapason.evals.core.scorer import LLMJudgeScorer
from diapason.evals.core.types import EvalRecord

LOGGER = logging.getLogger(__name__)

# ---------------------------------------------------------------------------
# Tool name mapping: Diapason name → PinchBench-expected name
# ---------------------------------------------------------------------------
...
def _tool_results_to_transcript(
    ...
    """Build transcript from DiapasonAgentBackend tool_results list."""
    transcript: List[Dict[str, Any]] = []
