...
from diapason.evals.cli import _build_backend, _run_terminalbench_native
...
class TestTerminalBenchNativeApiBase:
    @patch("diapason.evals.backends.terminalbench_native.TerminalBenchNativeBackend")
...
class TestRunSingleSuiteModeGating:
    @patch("diapason.evals.cli._run_terminalbench_native")
