...
from diapason.evals.core.runner import (
    EvalRunner,
    _metric_stats,
    _metric_stats_to_dict,
)
from diapason.evals.core.types import EvalRecord, MetricStats, RunConfig
from diapason.evals.tests.conftest import MockBackend, MockDataset, MockScorer
