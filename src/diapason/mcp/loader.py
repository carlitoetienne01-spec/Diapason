...
if TYPE_CHECKING:
    from diapason.core.types import ToolSpec  # noqa: F401
...
def load_mcp_tools_from_config(
    ...
    *,
    ...
    """
    # ``enabled`` and ``servers`` come from diapason.core.config's
    ...
    # Imported lazily so that `diapason.mcp.loader` can be imported
