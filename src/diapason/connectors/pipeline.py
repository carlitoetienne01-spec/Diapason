...
from diapason.connectors._stubs import Attachment, Document
from diapason.connectors.chunker import SemanticChunker
...
if TYPE_CHECKING:
    from diapason.connectors.attachment_store import AttachmentStore
