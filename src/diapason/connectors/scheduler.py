...
from diapason.connectors._stubs import BaseConnector
...
class SyncScheduler:
    ...
    ----------
    sync_engine:
        The :class:`~diapason.connectors.sync_engine.SyncEngine` used to
    ...
    def add(self, connector: BaseConnector) -> None:
        ...
        ----------
        connector:
            Any :class:`~diapason.connectors._stubs.BaseConnector` instance.
