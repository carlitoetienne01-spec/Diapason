...
from diapason.agents._stubs import AgentContext, BaseAgent
from diapason.core.events import Event, EventBus, EventType
from diapason.engine._base import looks_like_context_length_error
    ...
    async def stream(self) -> AsyncGenerator[str, None]:
        ...
        try:
            ...
            if engine is not None and hasattr(engine, "stream_full") and content:
                ...
                try:
                    from diapason.core.types import Message as MsgType
                    from diapason.core.types import Role as RoleType
                    ...
                    _logger = _logging.getLogger("diapason.server")
                    _logger.warning(
