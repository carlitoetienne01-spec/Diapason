...
def injection_result_from_json(json_str: str) -> object:
    ...
    from diapason.security.injection_scanner import (
        InjectionScanResult,
    )
    from diapason.security.types import ScanFinding, ThreatLevel
...
def retrieval_results_from_json(json_str: str) -> list:
    ...
    from diapason.tools.storage._stubs import RetrievalResult
