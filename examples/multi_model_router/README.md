...
Route queries to the cheapest capable model using Diapason's learning/routing
...
The script uses Diapason's routing infrastructure from the learning pillar:
