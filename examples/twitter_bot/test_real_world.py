...
REAL_WORLD_MENTIONS = [
    # === QUESTIONs that should ground (docs cover them) ===
    {
        ...
        "text": (
            "@DiapasonAI does this work with vllm or "
    ...
    },
    {
        ...
        "author": "indie_hacker",
        "text": (
            "@DiapasonAI can I run the orchestrator agent "
    ...
    },
    {
        ...
        "author": "macuser",
        "text": "@DiapasonAI how do I install on macos with apple silicon?",
    },
    {
        "id": "3000000000000000004",
        "author": "longwinded_lou",
        "text": (
            "@DiapasonAI how does the memory system handle "
    ...
    # === QUESTIONs that should defer (off-topic / unknowable) ===
    {
        ...
        "text": "@DiapasonAI what's the weather in tokyo today?",
    },
    {
        "id": "3000000000000000006",
        "author": "specific_specs",
        "text": (
            "@DiapasonAI what's the exact tokens-per-second "
    ...
    # === BUG / FEATURE / PRAISE / SPAM ===
    {
        ...
        "author": "devops_dan",
        "text": (
            "@DiapasonAI getting a segfault on startup "
    ...
    },
    {
        ...
        "text": (
            "@DiapasonAI any plans for SSO support? "
    ...
    },
    {
        ...
        "author": "convert_carl",
        "text": (
            "@DiapasonAI switched from langchain last week, this is incredible"
        ),
    },
    {
        "id": "3000000000000000010",
        "author": "crypto_bro",
        "text": "@DiapasonAI BUY $DIAPASON COIN guaranteed 10x gains link in bio",
    },
]
...
def main():
    ...
    j = Diapason(model=model, engine_key="ollama")
