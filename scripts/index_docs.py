#!/usr/bin/env python3
"""Index Diapason docs (README.md + docs/**/*.md) into a DenseMemory backend.
...
def build_index(
    ...
    *,
    ...
    dedupe: bool = True,
    # Empirical: on the actual Diapason docs the boilerplate that
    # crowds retrieval ("Diapason runs entirely on your hardware...")
...
def main() -> int:
    ...
    queries = args.query or [
        ...
        "what inference engines does diapason support?",
