...
mod tests {
    use super::*;
    use diapason_tools::builtin::calculator::CalculatorTool;

    fn make_server() -> McpServer {
        let mut exec = ToolExecutor::new(None, None);
        exec.register(diapason_tools::builtin::BuiltinTool::Calculator(CalculatorTool));
