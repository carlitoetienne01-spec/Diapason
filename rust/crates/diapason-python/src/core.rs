...
impl PyMessage {
    pub fn to_core(&self) -> diapason_core::Message {
        let role = match self.role.as_str() {
            "system" => diapason_core::Role::System,
            "assistant" => diapason_core::Role::Assistant,
            "tool" => diapason_core::Role::Tool,
            _ => diapason_core::Role::User,
        };
        diapason_core::Message {
            role,
...
pub struct PyEventBus {
    pub inner: std::sync::Arc<diapason_core::EventBus>,
}
...
impl PyEventBus {
    ...
    fn new() -> Self {
        Self {
            inner: std::sync::Arc::new(diapason_core::EventBus::new(true)),
        }
    }
