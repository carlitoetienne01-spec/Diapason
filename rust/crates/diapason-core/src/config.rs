...
//!
//! Rust translation of `src/diapason/core/config.py`.
...
/// Default config directory: `~/.diapason/`
pub fn default_config_dir() -> PathBuf {
    dirs_home().join(".diapason")
}

/// Default config file path: `~/.diapason/config.toml`
...
fn default_sandbox_image() -> String { "diapason-sandbox:latest".into() }
...
fn default_operators_dir() -> String { "~/.diapason/operators".into() }
